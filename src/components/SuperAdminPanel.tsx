...
import { ShieldAlert, Plus, Trash2, Edit2, CheckCircle2, AlertTriangle, Key, Landmark, Layers, ToggleLeft, ToggleRight, Phone, Receipt } from 'lucide-react';
...
export default function SuperAdminPanel() {
  ...
  useEffect(() => {
    const handleUpdate = () => {
      try {
        const saved = localStorage.getItem('licensed_madrasas');
        if (saved) setMadrasas(JSON.parse(saved));
      } catch (err) {}
    };
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500" dir="rtl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* Registration Form / Edit Card (Right side) */}
