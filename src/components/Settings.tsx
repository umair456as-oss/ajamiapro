...
const SubViewHeader = ({
  ...
  <div className="bg-slate-800 p-4 flex items-center justify-between text-white rounded-t-2xl">
    <div className="flex items-center gap-2">
      <button
        onClick={onBack}
        className="hover:bg-white/10 p-1 rounded-lg transition-all pr-4"
      >
        <X className="w-5 h-5" />
      </button>
      {extraActions}
...
export default function Settings({ onBack, onSubViewChange }: SettingsProps) {
  ...
  const [gradingTab, setGradingTab] = useState<"grades" | "positions">(
    "grades",
  );
  const [addressTab, setAddressTab] = useState<"address" | "district">(
    "address",
  );
  ...
  const [grades, setGrades] = useState(() => {
    try {
      ...
      return [{ id: 1, name: "اولیٰ", code: "01" }];
    }
  });
  ...
  const [books, setBooks] = useState(() => {
    try {
      ...
      return saved
        ? JSON.parse(saved)
        : ["قاعدہ", "نماز و دعائیں", "تجوید", "ہجاء", "پہنگی"];
    } catch (e) {
      return ["قاعدہ"];
    }
  });
  ...
  const handleAdd = (type: string) => {
    switch (type) {
      ...
      case "expulsion":
        ...
        setExpulsions([
          ...expulsions,
          {
            ...
            isCompleted: !!formInput.isCompleted,
          },
        ]);
        break;
      case "grade_setting":
      ...
      case "position":
        ...
        setPositions([
          ...positions,
          { id: positions.length + 1, name: formInput.position },
        ]);
        break;
    }
    setFormInput({});
  ...
  const handleDelete = (type: string, id: any) => {
    switch (type) {
      case "grade":
        ...
        break;
      case "address":
        setAddresses(addresses.filter((_, i) => i !== id));
        break;
      case "district":
        setDistricts(districts.filter((_, i) => i !== id));
        break;
      case "book":
        setBooks(books.filter((_, i) => i !== id));
        break;
      case "madrasa":
        setMadrasas(madrasas.filter((_, i) => i !== id));
        break;
      case "exam":
        setExams(exams.filter((_, i) => i !== id));
        break;
      case "hour":
        setHours(hours.filter((_, i) => i !== id));
        break;
      case "expulsion":
        setExpulsions(expulsions.filter((e) => e.id !== id));
        break;
      case "grade_setting":
        setGradeSettings(gradeSettings.filter((_, i) => i !== id));
        break;
      case "position":
  ...
  console.log('DEBUG: isAccountManagerAdmin', isAccountManagerAdmin);
            ...
            <div className="p-8 space-y-6 text-right" dir="rtl">
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormInput({ ...formInput, gradeName: e.target.value })
                  }
              ...
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormInput({ ...formInput, gradeCode: e.target.value })
                  }
              ...
              <div className="pt-6 border-t border-slate-100">
                <h4 className="text-xs font-bold text-slate-400 mb-4 uppercase text-right">
                  موجودہ درجات
                </h4>
                          ...
                          <td className="py-3 px-4">
                            <div className="flex gap-1 justify-end">
                              <button
                                ...
                                className="bg-red-500 text-white px-2 py-1 rounded text-[10px] font-urdu hover:bg-red-600 transition-colors"
                              >
                                ڈیلیٹ
                              </button>
                            </div>
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                  ...
                  <div className="pt-6 h-80 overflow-y-auto">
                    <table className="w-full text-right">
                      <thead className="text-[10px] text-slate-400 bg-slate-50 sticky top-0">
                        <tr>
                          <th className="py-2 px-4 text-center w-12 italic font-mono">
                            No
                          </th>
                      ...
                      <tbody className="text-sm">
                        {addresses.map((addr, idx) => (
                          ...
                          >
                            ...
                            <td className="py-3 px-4 font-urdu text-slate-600">
                              {addr}
                            </td>
                            <td className="py-3 px-4">
                              <button
                                onClick={() => handleDelete("address", idx)}
                                className="bg-red-500 text-white px-2 py-1 rounded text-[10px] font-urdu"
                              >
                                ڈیلیٹ
                              </button>
                            </td>
                      ...
                      <tbody className="text-sm">
                        {districts.map((dist, idx) => (
                          ...
                          >
                            ...
                            <td className="py-3 px-4">
                              <button
                                onClick={() => handleDelete("district", idx)}
                                className="bg-red-500 text-white px-2 py-1 rounded text-[10px] font-urdu"
                              >
                                ڈیلیٹ
                              </button>
            ...
            <div className="p-8 space-y-6 text-right" dir="rtl">
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormInput({ ...formInput, book: e.target.value })
                  }
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-blue-600 text-white py-3 rounded-xl font-urdu font-bold hover:bg-blue-700 transition-all"
                >
                  محفوظ کریں
                </button>
                <button
                  onClick={() => setFormInput({ ...formInput, book: "" })}
                  className="flex-1 bg-slate-500 text-white py-3 rounded-xl font-urdu font-bold hover:bg-slate-600"
                >
                  منسوخ کریں
                </button>
              </div>
            ...
            <div className="p-8 space-y-6 text-right" dir="rtl">
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormInput({ ...formInput, madrasa: e.target.value })
                  }
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => handleAdd("madrasa")}
                  className="flex-1 bg-blue-600 text-white py-3 rounded-xl font-urdu font-bold hover:bg-blue-700"
                >
                  محفوظ کریں
                </button>
                <button
                  onClick={() => setFormInput({ ...formInput, madrasa: "" })}
                  className="flex-1 bg-slate-500 text-white py-3 rounded-xl font-urdu font-bold hover:bg-slate-600"
                >
                  منسوخ کریں
                </button>
                        ...
                        {madrasas.map((m, idx) => (
                          ...
                          >
                            ...
                            <td className="py-3 px-4 text-left">
                              <button
                                onClick={() => handleDelete("madrasa", idx)}
                                className="bg-red-500 text-white px-2 py-1 rounded text-[10px] font-urdu"
                              >
                                ڈیلیٹ
                              </button>
            ...
            <div className="p-8 space-y-6 text-right" dir="rtl">
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormInput({ ...formInput, exam: e.target.value })
                  }
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-blue-600 text-white py-3 rounded-xl font-urdu font-bold"
                >
                  محفوظ کریں
                </button>
                <button
                  onClick={() => setFormInput({ ...formInput, exam: "" })}
                  className="flex-1 bg-slate-500 text-white py-3 rounded-xl font-urdu font-bold"
                >
                  منسوخ کریں
                </button>
              </div>
            ...
            <div className="p-8 space-y-6 text-right" dir="rtl">
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormInput({ ...formInput, hour: e.target.value })
                  }
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => setFormInput({ ...formInput, hour: "" })}
                  className="flex-1 bg-slate-500 text-white py-3 rounded-xl font-urdu font-bold"
                >
                  منسوخ کریں
                </button>
              ...
              {gradingTab === "grades" ? (
                <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                  <div className="space-y-6">
                    <h4 className="bg-emerald-600 text-white px-4 py-1 text-xs inline-block rounded">
                      نیا گریڈ شامل کریں
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                      <div className="space-y-1">
                        <label className="text-[10px] text-slate-400 whitespace-nowrap text-right block">
                          گریڈ کا نام *
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFormInput({
                              ...formInput,
                              graceMarks: Number(e.target.value),
                            })
                          }
                          className="w-full px-4 py-2 bg-white border border-slate-200 rounded text-xs outline-none"
                        />
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          >
                            اس فیصد سے کم پر راسب
                          </label>
                        </div>
                      </div>
                    </div>
                    <button
                      onClick={() => handleAdd("grade_setting")}
                      className="bg-blue-600 text-white px-8 py-2 rounded font-bold text-xs hover:bg-blue-700 transition-all"
                    >
                      شامل کریں
                    </button>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h4 className="bg-blue-600 text-white px-4 py-1 text-xs inline-block rounded">
                      موجودہ گریڈ ترتیبات
                    </h4>
                    {gradeSettings.length === 0 ? (
                      <div className="py-12 border-2 border-dashed border-slate-50 rounded-xl text-center text-xs text-slate-400">
                        کوئی گریڈ ترتیب موجود نہیں ہے۔ اوپر دیے گئے فارم سے نئی
                        ترتیب شامل کریں۔
                      </div>
                    ) : (
                          ...
                          <tbody>
                            {gradeSettings.map((gs, idx) => (
                              ...
                              >
                                ...
                                <td className="p-3">
                                  {gs.isFail ? (
                                    <span className="text-red-500">راسب</span>
                                  ) : (
                                ...
                                <td className="p-3">
                                  <button
                                    onClick={() =>
                                      handleDelete("grade_setting", idx)
                                    }
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-300">
                  <div className="bg-slate-50 rounded-xl overflow-hidden border border-slate-200">
                    <div className="bg-cyan-500 text-white px-4 py-2 text-xs font-bold">
                      پوزیشن کی کم از کم فیصد سیٹ کریں
                    </div>
                    <div className="p-6">
                      <div className="bg-white border border-blue-100 p-4 rounded-lg flex items-start gap-4 mb-4">
                        <div className="flex-1 text-[11px] leading-relaxed text-slate-600">
                          <span className="font-bold text-slate-900 block mb-1 underline">
                            وضاحت:
                          </span>
                          طلبہ کی فیصد اس سیٹ کردہ فیصد تک پہنچنی چاہیے ہو تو اس
                          سے آگے پوزیشن دی جائے گی۔ مثال کے طور پر اگر آپ 70%
                          سیٹ کریں تو صرف وہی طلبہ پوزیشن پائیں گے جن کے فیصد
                          70% یا اس سے زیادہ ہو گی۔ جو طلبہ 70% سے کم فیصد حاصل
                          کریں گے، انہیں کوئی پوزیشن نہیں دی جائے گی۔
                        </div>
                        <div className="space-y-2 w-32">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setMinPositionPercentage(Number(e.target.value))
                            }
                            className="w-full px-3 py-2 border border-slate-200 rounded text-sm outline-none"
                          />
                        </div>
                        <button className="bg-cyan-500 text-white w-12 h-12 rounded-full text-[10px] flex items-center justify-center font-bold shadow-lg shadow-cyan-200 shrink-0 hover:scale-105 active:scale-95 transition-all">
                          سیٹ کریں
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-xl overflow-hidden border border-slate-200">
                    <div className="bg-emerald-600 text-white px-4 py-2 text-xs font-bold">
                      نئی پوزیشن شامل کریں
                    </div>
                  ...
                  <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
                    <div className="bg-blue-600 text-white px-4 py-2 text-xs font-bold">
                      موجودہ پوزیشن ترتیبات
                    </div>
                    <div className="p-6 space-y-4">
                      <p className="text-[10px] text-slate-400">
                        ہر پوزیشن کا نام اپنی مرضی سے تبدیل کر سکتے ہیں ۔ مثال :
                        اول، دوم، سوم یا فرسٹ ، سیکنڈ ، تھرڈ وغیرہ ۔
                      </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {positions.map((pos) => (
                          ...
                          >
                            <span className="absolute top-2 right-4 bg-slate-400 text-white px-2 py-0.5 rounded text-[8px] font-bold">
                              پوزیشن {pos.id}
                            </span>
                            <button
            ...
            <div className="p-8 space-y-6 text-right" dir="rtl">
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormInput({ ...formInput, reason: e.target.value })
                  }
              ...
              <div className="flex items-start gap-3 bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                ...
                />
                <div className="space-y-1">
                  <p className="text-xs font-urdu text-slate-700 font-bold">
                    کلاس / ارسال مکمل ہوا ہے؟
                  </p>
                  <p className="text-[10px] font-urdu text-slate-400">
                    اگر چیک باکس چیک کریں گے تو اس سے منتخب ہو گا کہ طالب علم نے
                    اپنا سال / کلاس مکمل کر لیا ہے۔
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                <button
                  onClick={() => handleAdd("expulsion")}
                  className="flex-1 bg-blue-600 text-white py-3 rounded-xl font-urdu font-bold hover:bg-blue-700 shadow-lg shadow-blue-500/10"
                >
                  محفوظ کریں
                </button>
                <button
                    ...
                    <tbody className="text-sm">
                      {expulsions.map((exp) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            {exp.isCompleted ? "مکمل" : "نامکمل"}
                          </td>
                          <td className="py-3 px-4 text-left">
                            <button
                              onClick={() => handleDelete("expulsion", exp.id)}
    ...
    <div className="flex flex-col h-full bg-slate-50 overflow-hidden relative">
      ...
      <div className="bg-white px-8 py-6 flex items-center justify-between border-b border-slate-200 shadow-sm z-10">
        ...
        <div className="flex items-center gap-4" dir="rtl">
          ...
          <h1 className="text-2xl font-bold font-urdu text-slate-900">
            ترتیبات (Settings)
          </h1>
        </div>
      </div>
      ...
      {/* Tabs Navigation */}
      <div
        className="bg-white px-8 py-2 border-b border-slate-200 flex justify-end gap-2 relative z-10"
        dir="rtl"
      >
        {tabs.map((tab) => (
          <button
          ...
          {activeTab === "basic" && (
            <>
              {currentSubView ? (
                ...
                <div
                  className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in slide-in-from-top-4 duration-500"
                  dir="rtl"
                >
                  <SettingButton
                    label="تمام ایڈریس"
                    onClick={() => setCurrentSubView("addresses")}
                  />
                  <SettingButton
                    label="پڑھائی جانے والی کتابیں"
                    icon={Book}
                    onClick={() => setCurrentSubView("books")}
                  />
                  <SettingButton
                    label="پڑھائے جانے والے درجات"
                    icon={GraduationCap}
                    onClick={() => setCurrentSubView("grades")}
                  />

                  <SettingButton
                    label="سابقہ مدارس کے نام"
                    icon={MapPin}
                    onClick={() => setCurrentSubView("madrasas")}
                  />
                  <SettingButton
                    label="امتحان کے نام"
                    icon={FileText}
                  ...
                  />
                  <SettingButton
                    label="حاضری کے اوقات"
                    icon={Clock}
                    onClick={() => setCurrentSubView("hours")}
                  />

                  <SettingButton
                    label="تصویر و پوریشن کا معیار"
                    icon={FileText}
                    onClick={() => setCurrentSubView("grading")}
                  />
                  <SettingButton
                    label="رجسٹریشن نمبر ترتیبات"
                    icon={Plus}
                    active={true}
                    onClick={() => setActiveTab("registration")}
                  />
                  <SettingButton
                    label="اخراج کی وجوہات"
                    icon={Plus}
                    onClick={() => setCurrentSubView("expulsion")}
                  />
                </div>
              )}
            </>
          ...
          {activeTab === "registration" && (
            <div className="max-w-2xl mx-auto bg-white rounded-[40px] shadow-2xl overflow-hidden border border-slate-100 animate-in fade-in zoom-in duration-500">
              <div className="bg-blue-600 p-4 text-center">
                <h3 className="text-white font-urdu font-bold">
                  رجسٹریشن نمبر فارمیٹ ترتیبات
                </h3>
              </div>
              <div className="p-10 space-y-8" dir="rtl">
                <div className="space-y-4">
                  <label className="text-sm font-urdu text-slate-700 block text-right">
                    رجسٹریشن نمبر فارمیٹ :
                  </label>
                  <input
                    type="text"
                  ...
                  <p className="text-[10px] font-urdu text-slate-400 leading-relaxed">
                    دستی ٹیگ استعمال کریں:{" "}
                    <span className="text-red-500 font-mono">[class]</span> کلاس
                    کا کوڈ،{" "}
                    <span className="text-red-500 font-mono">[year]</span> سال،{" "}
                    <span className="text-red-500 font-mono">[serial]</span>{" "}
                    سیریل نمبر۔ علیحدگی کنندہ خود شامل کریں جیسے - یا / ۔ مثال:{" "}
                    <span className="text-slate-900 font-mono">
                      [class]-[year]/[serial]
                    </span>{" "}
                    مِیں سے کم از کم ایک ٹیگ استعمال کریں۔
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4">
                  <span className="text-xs font-urdu text-slate-400 block text-right">
                    پیش نظارہ:
                  </span>
                ...
                <div className="flex gap-3 pt-6">
                  <button className="flex-1 bg-blue-600 text-white py-4 rounded-2xl font-urdu font-bold hover:bg-blue-700 shadow-lg shadow-blue-500/20">
                    محفوظ کریں
                  </button>
                  <button className="px-8 bg-slate-500 text-white py-4 rounded-2xl font-urdu font-bold hover:bg-slate-600">
                    واپس
                  </button>
                </div>
              </div>
          ...
          {activeTab === "date" && (
            ...
            >
              <div className="bg-white p-10 rounded-[32px] border border-slate-100 shadow-xl">
                <h3 className="text-lg font-urdu text-slate-700 mb-6">
                  طالب علم کی حاضری کے لیے کیلنڈر کی قسم
                </h3>
                <div className="flex flex-col gap-4">
                  <label className="text-xs font-urdu text-slate-400">
                    کیلنڈر کی قسم
                  </label>
                  <select className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-xl outline-none">
                    <option>عیسوی</option>
                  </select>
                  <button className="self-center bg-emerald-600 text-white px-8 py-2 rounded-full font-urdu text-sm hover:bg-emerald-700 transition-all mt-4">
                    محفوظ کریں
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white p-10 rounded-[32px] border border-slate-100 shadow-xl">
                <h3 className="text-lg font-urdu text-slate-700 mb-6">
                  اسٹاف کی حاضری کے لیے کیلنڈر کی قسم
                </h3>
                <div className="flex flex-col gap-4">
                  <label className="text-xs font-urdu text-slate-400">
                    کیلنڈر کی قسم
            ...
            >
              <div className="flex gap-4 border-b border-slate-100 pb-2">
                ...
                >
                  ...
                  {onlineApplications.filter((a) => a.status === "pending")
                    .length > 0 && (
              ...
              {onlineTab === "links" ? (
                <>
                  <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-xl space-y-6">
                    <div className="text-center space-y-2">
                      <h3 className="text-xl font-bold font-urdu text-slate-800">
                        آن لائن اندراج لنک جنریٹ کریں
                      </h3>
                      <p className="text-xs font-urdu text-slate-400">
                        اس لنک سے طلبہ آن لائن فارم بھر سکتے ہیں، جو پینڈنگ میں
                        جمع ہو جائیں گے۔
                      </p>
                      <p className="text-[10px] font-urdu text-slate-300">
                        استعمال کی تعداد (ڈیفالٹ: 1)
                      </p>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormInput({
                            ...formInput,
                            linkUses: Number(e.target.value),
                          })
                        }
                      ...
                      <div className="bg-emerald-50 border border-emerald-100 p-8 rounded-[32px] space-y-4 animate-in zoom-in duration-300">
                        <div className="flex justify-between items-start">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-2">
                              <span className="text-xs font-urdu font-bold text-slate-700">
                                لنک:
                              </span>
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="text-[10px] text-blue-500 underline break-all font-mono"
                              >
                                {generatedLink.url}
                              </a>
                            </div>
                          ...
                          <div className="bg-white p-2 rounded-xl shadow-sm">
                            ...
                            <span className="text-[10px] font-urdu text-slate-400 block text-center mt-1">
                              QR کوڈ
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="bg-white rounded-[32px] overflow-hidden border border-slate-100 shadow-xl">
                    <div className="p-6 bg-slate-50 border-b border-slate-100">
                      <h3 className="text-lg font-bold font-urdu text-slate-700">
                        گزشتہ بنائے گئے لنک
                      </h3>
                    </div>
                    <div className="overflow-x-auto">
                      <table className="w-full text-right" dir="rtl">
                        <thead className="bg-[#1e293b] text-white">
                          <tr>
                            <th className="px-6 py-4 text-xs font-urdu">
                              لنک (ماسکڈ)
                            </th>
                            <th className="px-6 py-4 text-xs font-urdu">
                              بنایا گیا
                        ...
                        <tbody className="text-xs">
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-2">
                                  {item.remainingUses === 0 ? (
                                    <span className="bg-red-500 text-white px-4 py-1 rounded-full text-[10px] font-urdu">
                                      غیر فعال ڈیلیٹ
                                    </span>
                                  ) : (
                                    <>
                                      ...
                                      >
                                        <QrCode className="w-3 h-3" /> دوبارہ
                                        استعمال (لنک/QR)
                                      </button>
                                      <button
                                        onClick={() =>
                          ...
                          {onlineLinks.length === 0 && (
                            <tr>
                              <td
                                colSpan={5}
                                className="py-12 text-center text-slate-400 font-urdu"
                              >
                                کوئی لنک دستیاب نہیں ہے
                              </td>
                            </tr>
                          )}
                        </tbody>
                ...
                <div className="bg-white rounded-[32px] overflow-hidden border border-slate-100 shadow-xl animate-in fade-in duration-300">
                  <div className="p-6 bg-slate-50 border-b border-slate-100">
                    <h3 className="text-lg font-bold font-urdu text-slate-700">
                      آن لائن موصول ہونے والی درخواستیں
                    </h3>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full text-right" dir="rtl">
                      ...
                      <tbody className="text-xs">
                        {onlineApplications.map((app) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <span
                                className={`px-3 py-1 rounded-full text-[10px] font-urdu ${
                                  app.status === "pending"
                              ...
                              <div className="flex gap-2">
                                ...
                                {app.status === "pending" && (
                                  <>
                                    <button
                                      onClick={() => {
                                        setOnlineApplications(
                                          onlineApplications.map((a) =>
                                            a.id === app.id
                                              ? { ...a, status: "accepted" }
                                              : a,
                                          ),
            ...
            >
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold font-urdu text-slate-800">
                      نظام کی ترتیبات (System Settings)
                    </h2>
                    <p className="text-[10px] text-slate-400 font-urdu">
                      سافٹ ویئر کی کارکردگی اور ڈیزائن کو کنٹرول کریں
                    </p>
                  </div>
                </div>
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      localStorage.setItem(
                        "madrasas",
                        JSON.stringify(madrasas),
                      );
                      localStorage.setItem("exams", JSON.stringify(exams));
                      localStorage.setItem("hours", JSON.stringify(hours));
                      localStorage.setItem(
                        "expulsions",
                        JSON.stringify(expulsions),
                      );
                      localStorage.setItem(
                        "gradeSettings",
                        JSON.stringify(gradeSettings),
                      );
                      localStorage.setItem(
                        "minPositionPercentage",
                        String(minPositionPercentage),
                      ...
                      if (success) {
                        alert(
                          "مبارک ہو! ترتیبات کامیابی سے محفوظ اور دیگر فعال آلات پر سنک کر دی گئی ہیں۔",
                        );
                      } else {
                        alert(
                          "ترتیبات مقامی طور پر محفوظ ہو چکی ہیں، انٹرنیٹ دستیاب ہوتے ہی خودکار سنک ہو جائیں گی۔",
                        );
                      }
                    } catch (err) {
                      console.error("Error saving settings:", err);
                      alert(
                        "معذرت! ترتیبات محفوظ کرنے میں خرابی پیش آئی ہے۔ دوبارہ کوشش کریں۔",
                      );
                    } finally {
                      setIsSaving(false);
                    }
                ...
                >
                  ...
                  />
                  <span>
                    {isSaving ? "محفوظ ہو رہا ہے..." : "محفوظ کریں (Save All)"}
                  </span>
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1 space-y-3">
                  {[
                    {
                      id: "basic_monogram",
                      label: "بنیادی و مونوگرام",
                      icon: SettingsIcon,
                    },
                    {
                      id: "security",
                      label: "سیکیورٹی و پاسورڈ",
                      icon: ShieldCheck,
                    },
                    ...
                    >
                      ...
                      <X
                        className={`w-3 h-3 rotate-45 transition-transform ${systemActiveTab === item.id ? "opacity-100" : "opacity-0"}`}
                      />
                    </button>
                  ))}
                </div>
                      ...
                      <div className="space-y-10 animate-in fade-in duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                          ...
                          <div className="flex flex-col items-center justify-center p-8 bg-slate-50 rounded-[32px] border-2 border-dashed border-slate-200 group relative">
                            <div className="text-[10px] text-slate-400 absolute top-4 left-4 font-urdu">
                              منظرہ / مونوگرام
                            </div>
                        ...
                        <div className="flex justify-end pt-6 border-t border-slate-100 w-full col-span-full">
                          <button
                            type="button"
                            disabled={isSaving}
                            onClick={async () => {
                              ...
                              try {
                                ...
                                const success = await syncToServer();
                                if (success) {
                                  alert("مبارک ہو! ترتیبات کامیابی سے محفوظ اور سنک کر دی گئی ہیں۔");
                                } else {
                                  alert("ترتیبات محفوظ ہو چکی ہیں، انٹرنیٹ دستیاب ہوتے ہی خودکار سنک ہو جائیں گی۔");
                                }
                              } catch (e) {
                                console.error("Error:", e);
                                alert("معذرت! محفوظ کرنے میں خرابی پیش آئی۔");
                              } finally {
                                setIsSaving(false);
                              }
                            }}
                            className="bg-emerald-600 hover:bg-emerald-700 text-white font-urdu font-bold px-8 py-3.5 rounded-2xl shadow-xl shadow-emerald-600/10 hover:shadow-emerald-600/20 active:scale-95 transition-all text-sm flex items-center gap-2"
                          >
                            <FileText className={`w-4 h-4 ${isSaving ? "animate-spin" : ""}`} />
                            <span>{isSaving ? "ترتیبات محفوظ ہو رہی ہیں..." : "ترتیبات محفوظ کریں (Save Settings)"}</span>
                          </button>
                        </div>
                      </div>
                    )}
                    ...
                    {systemActiveTab === "security" && (
                      <div className="space-y-10 animate-in fade-in duration-300 max-w-lg mx-auto">
                        ...
                        <div className="space-y-6 pt-4">
                          ...
                          <button className="w-full py-4 bg-slate-900 text-white rounded-2xl font-urdu font-bold shadow-xl shadow-slate-900/20 hover:bg-black transition-all active:scale-95 flex items-center justify-center gap-3">
                      ...
                      <div className="space-y-10 animate-in fade-in duration-300">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                          ...
                          <div className="flex-[2] bg-slate-50 border border-slate-200 rounded-[32px] p-8">
                            <h4 className="text-[10px] font-bold text-slate-400 font-urdu mb-4 uppercase">
                              کلاس لسٹ (دستیاب درجے)
                            </h4>
                            <div className="flex flex-wrap gap-3">
                              {[
                                ...
                                <div
                                  key={c}
                                  className="bg-white border border-slate-200 px-6 py-3 rounded-2xl shadow-sm text-sm font-urdu text-slate-700 hover:border-blue-400 transition-colors cursor-pointer"
                                >
                                  {c}
                                </div>
                              ))}
                    ...
                    {systemActiveTab === "exam_std" && (
                      <div className="space-y-10 animate-in fade-in duration-300">
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <h3 className="text-xl font-bold font-urdu text-slate-800">
                            امتحانی معیار و حاضری
                          </h3>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div className="space-y-4">
                            <label className="text-sm font-bold font-urdu text-slate-700 pr-2">
                              امتحان پاس کرنے کے نمبر (%)
                            </label>
                            <div className="relative group">
                              ...
                              />
                              <div className="absolute inset-y-0 left-6 flex items-center text-slate-300 font-bold">
                                %
                              </div>
                            </div>
                          </div>
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-end pt-6 border-t border-slate-100 col-span-full w-full">
                              <button
                                type="button"
                                disabled={isSaving}
                                onClick={async () => {
                    ...
                    {systemActiveTab === "backup_restore" && (
                      <div className="space-y-10 animate-in fade-in duration-300">
                        <div className="flex items-center gap-4 mb-2">
                          <div className="h-0.5 w-12 bg-blue-600" />
                          <h3 className="text-xl font-bold font-urdu text-slate-800">
                            ڈیٹا بیک اپ و ریسٹور (Backup & Restore)
                          </h3>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          ...
                          <div className="bg-slate-50 p-8 rounded-[32px] border border-slate-100 flex flex-col items-center text-center space-y-4">
                            ...
                            <h4 className="text-lg font-bold font-urdu text-slate-800">
                              ماسٹر بیک اپ ایکسپورٹ
                            </h4>
                            <p className="text-xs font-urdu text-slate-400">
                              اس بٹن پر کلک کرنے سے آپ کا تمام ڈیٹا (ڈیٹا بیس
                              اور تصاویر) ایک .zip فائل میں محفوظ ہو جائے گا۔
                            </p>
                            <button
                              onClick={async () => {
                                try {
                                  window.open(
                                    `${API_BASE_URL}/api/backup`,
                                    "_blank",
                                  );
                                } catch (err) {
                          ...
                          <div className="bg-slate-50 p-8 rounded-[32px] border border-slate-100 flex flex-col items-center text-center space-y-4">
                            ...
                            <h4 className="text-lg font-bold font-urdu text-slate-800">
                              بیک اپ ریسٹور / امپورٹ
                            </h4>
                            <p className="text-xs font-urdu text-slate-400">
                              اپنا پہلے سے موجود بیک اپ (.zip فائل) یہاں اپلوڈ
                              کریں تاکہ سافٹ ویئر کا تمام پرانا ریکارڈ بحال ہو
                              جائے۔
                            </p>
                                ...
                                onChange={async (e) => {
                                  if (e.target.files && e.target.files[0]) {
                                    ...
                                    try {
                                      ...
                                      if (res.success) {
                                        alert(
                                          "بیک اپ کامیابی سے ریسٹور ہو گیا۔ براہ کرم سافٹ ویئر ری اسٹارٹ کریں۔",
                                        );
                                      } else {
                          ...
                          <div className="bg-slate-50 p-8 rounded-[32px] border border-slate-100 flex flex-col items-center text-center space-y-4">
                            ...
                            <h4 className="text-lg font-bold font-urdu text-slate-800">
                              صرف ڈیٹا بیس ایکسپورٹ
                            </h4>
                            <p className="text-xs font-urdu text-slate-400">
                              صرف "madrassa.db" فائل کو ڈاؤن لوڈ کرنے کے لیے یہ
                              بٹن استعمال کریں۔ (تصاویر شامل نہیں ہوں گی)
                            </p>
                            <button
                              onClick={() =>
                                window.open(
                          ...
                          <div className="bg-slate-50 p-8 rounded-[32px] border border-slate-100 flex flex-col items-center text-center space-y-4">
                            ...
                            <p className="text-xs font-urdu text-slate-400">
                              اگر آپ کے پاس پہلے سے "madrassa.db" فائل ہے تو اسے
                              یہاں سے اپلوڈ کر کے پرانا ڈیٹا ری اسٹور کریں۔
                            </p>
                                ...
                                onChange={async (e) => {
                                  if (e.target.files && e.target.files[0]) {
                                    ...
                                    try {
                                      ...
                                      if (res.success)
                                        alert(
                                          "ڈیٹا بیس کامیابی سے تبدیل کر دیا گیا۔",
                                        );
                                      else
                                        alert("امپورٹ میں خرابی: " + res.error);
                                    } catch (err) {
                        ...
                        <div className="bg-amber-50 border border-amber-200 p-6 rounded-2xl flex items-start gap-4">
                          ...
                          <div className="text-xs font-urdu text-amber-800 leading-relaxed">
                            <strong>توجہ فرمائیں:</strong> بیک اپ ریسٹور کرنے سے
                            آپ کا موجودہ ڈیٹا مکمل طور پر ختم ہو جائے گا اور بیک
                            اپ فائل والا ڈیٹا اس کی جگہ لے لے گا۔ اس لیے ریسٹور
                            کرنے سے پہلے تسلی کر لیں کہ آپ درست فائل استعمال کر
                            رہے ہیں۔
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-[40px] p-12 relative overflow-hidden">
                          ...
                          <div className="space-y-8 relative z-10">
                            <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                              ...
                              <span className="text-sm font-bold font-urdu text-slate-700">
                                :سافٹ ویئر ورژن
                              </span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-200 pb-4">
